...
public   class  Client {
	...
	Client(String server, int port, String username) {
		if (FM.FeatureModel.chat) {
			// which calls the common constructor with the GUI set to null
			Client(server, port, username, null);
				}
	}
	 ...
	 * parameter is null
	 */
	public void Client(String server, int port, String username, ClientGUI cg) {
		this.server = server;
		this.port = port;
	...
	public static void main(String[] args) {
	 ...
	 private static void  initS__wrappee__Chat  (String[] args) {
	}

	
	public static void initS(String[] args) {
		if (!FM.FeatureModel.clientgui) {
			initS__wrappee__Chat(args);
			return;
		}
		int portNumber = 1500;
	 ...
	 private static void  initC__wrappee__Chat  (String[] args) {

	}

	
	public static void initC(String[] args) {
		if (!FM.FeatureModel.clientconsole) {
			initC__wrappee__Chat(args);
			return;
		}
		int portNumber = 1500;
		String serverAddress = "localhost";
		String userName = "Anonymous";
		console(portNumber, serverAddress, userName, args);
	}

	

	public static void console(int portNumber, String serverAddress, String userName, String[] args){
