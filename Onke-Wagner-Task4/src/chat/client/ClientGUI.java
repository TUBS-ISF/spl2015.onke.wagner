...
public class ClientGUI extends JFrame implements ActionListener {
	...
	public void init() {
		if (clientAddressPlugin != null) {
			defaultPort = clientAddressPlugin.getDefaultPort();
			defaultHost = clientAddressPlugin.getDefaultHost();
		}
		...
		// number
		if (clientAddressPlugin != null) {
			tfServer = new JTextField(clientAddressPlugin.getDefaultHost());
			tfPort = new JTextField("" + clientAddressPlugin.getDefaultPort());
			tfPort.setHorizontalAlignment(SwingConstants.RIGHT);

			serverAndPort.add(new JLabel(clientAddressPlugin.getServerAddressText()));
			serverAndPort.add(tfServer);
			serverAndPort.add(new JLabel(clientAddressPlugin.getPortNumberText()));
	...
	void connectionFailed() {
		...
		if (clientAddressPlugin != null) {
			tfServer.setEditable(clientAddressPlugin.setEditableFalse());
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == login) {
			...
			if (clientAddressPlugin != null) {
				server = clientAddressPlugin.getServerInput();
			}
